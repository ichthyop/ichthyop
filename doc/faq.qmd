...
## Java Heap Space {#sec-faq-heap-space}
...
![Particle current location at `X(x, y, z)`](_static/spatial_interpolation.png){fig-align="center"}
...
![](_static/spatial_interpolation_u(1).png){fig-align="center"}
...
![](_static/spatial_interpolation_coast.png){fig-align="center"}
