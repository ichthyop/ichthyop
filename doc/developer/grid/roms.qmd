...
![ROMS grid as interpreted by Ichthyop](grid/_static/ichthyop_grid_roms.jpg)


##### Land-sea mask

![Land-sea masking for ROMS grid](grid/_static/land_sea_mask_roms.jpg)
...
![Interpolation of T points from ROMS grid](grid/_static/interpolation_t_roms.jpg)
...
![Interpolation of U points from ROMS grid](grid/_static/interpolation_u_roms.jpg)
...
![Interpolation of V points from ROMS grid](grid/_static/interpolation_v_roms.jpg)
...
![Excluded domain in the Ichthyop ROMS simulations.](grid/_static/is_on_edge_roms.jpg)
