...
`ichthyop-X.Y.Z-jar-with-dependencies.jar` file, where `X.Y.Z` is the Ichthyop version. The
Ichthyop console should open up
...
is the XML configuration file (see @sec-sec-ich-conf)
