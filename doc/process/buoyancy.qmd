...
- If `file`, then the buoyancy is read from a file and can vary with either age or length. The class that is used is provided by the `particle.class` parameter.
