...
public class OutputNC {
  ...
  final public static int BIOMARKER_1 = 13;
  final public static int BIOMARKER_2 = 14;

  final public static int NB_FIELDS = 15;
  ...
  public static void createFile(int i_simu, int nb_simu, int typeSimu) {
    ...
    if (GetConfig.isBiomarker1()) {
      addDoubleVar2Schema(BIOMARKER_1);
    }
    if (GetConfig.isBiomarker2()) {
      addDoubleVar2Schema(BIOMARKER_2);
    }
