...
public class GetConfig {
  ...
  private static boolean BLN_BIOMARKER_1;
  private static boolean BLN_BIOMARKER_2;
  ...
  private static String STR_BIOMARKER_1;
  private static String STR_BIOMARKER_2;
  ...
  private void getFieldNames() {
    ...
    if (isBiomarker1()) {
      STR_BIOMARKER_1 = getStringProperty(Resources.STR_SECTION_NAMES,
            Resources.STR_CFG_BIOMARKER_1);
    }
    if (isBiomarker2()) {
      STR_BIOMARKER_2 = getStringProperty(Resources.STR_SECTION_NAMES,
            Resources.STR_CFG_BIOMARKER_2);
    }
  ...
  private void getInfoSingleSimu() throws Exception {
    ...
    BLN_BIOMARKER_1 = cfgFile.getBooleanProperty(Resources.STR_SECTION_BIO,
        Resources.STR_CFG_BIOMARKER_1);
    BLN_BIOMARKER_2 = cfgFile.getBooleanProperty(Resources.STR_SECTION_BIO,
        Resources.STR_CFG_BIOMARKER_2);
  ...
  //---------------------------------------------------------
  public static boolean isBiomarker1() {
    return BLN_BIOMARKER_1;
  }

  //---------------------------------------------------------
  public static boolean isBiomarker2() {
    return BLN_BIOMARKER_2;
  }
  ...
  //--------------------------------------------------------------------------
  public static String getStrBiomarker1() {
    return STR_BIOMARKER_1;
  }

  //--------------------------------------------------------------------------
  public static String getStrBiomarker2() {
    return STR_BIOMARKER_2;
  }
