...
///////////////
     ...
     */
    public Step(int time_arrow, int dt_refresh) {
        ...
        i_simulation = -1;
        dt = time_arrow * Configuration.get_dt();
...
////////////////////////////
    ...
    public String timeLeft() {
        ...
        float x = (i_simulation + (i_step + 1) / (float) nb_steps) /
                  nb_simulations;
