    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == btnSave) {
            if (file == null) {
                ...
                fc.setFileFilter(new FileNameExtensionFilter(Resources.EXTENSION_CONFIG + " (*.cfg)", "cfg"));
...
////////////////////////////////////////////////////////////////////////////////
    private class TabIO extends JPanel implements ITab,
        ...
        private JTextField txtInputpath,  txtOutputpath,  txtFilenameFilter,  txtDrifterPathname,  txtOutputFilename,  txtGridfile;
        private JCheckBox ckBoxOutput,  ckBoxGridfile;
        private JButton btnInputpath,  btnOutputpath,  btnDrifterPathname,  btnGridfile;
        ...
        public void read(INIFile file) {
            ...
            if (!path.matches("null")) {
                txtDrifterPathname.setText(uriCurrent.relativize(new File(path).toURI()).getPath());
            }
            ...
            if (!path.matches("null")) {
                txtOutputpath.setText(uriCurrent.relativize(new File(path).toURI()).
                        getPath());
            }
            ...
            /** record tracks */
            bln = file.getBooleanProperty(Structure.SECTION_IO,
                    Structure.RECORD);
            if (bln) {
                ckBoxOutput.doClick();
        ...
        public void write(INIFile file) {
            ...
            file.setBooleanProperty(Structure.SECTION_IO,
                    Structure.GRIDFILE,
                    ckBoxGridfile.isSelected(),
                    null);
            String pathname = "null";
            if (ckBoxGridfile.isSelected() && txtGridfile.getText().trim().length() != 0) {
                pathname = txtGridfile.getText();
            }
            file.setStringProperty(Structure.SECTION_IO,
                    Structure.PATH_GRIDFILE,
                    pathname,
            ...
            /** drifter pathname */
            pathname = "null";
            if (tabRelease.rdBtnFile.isSelected() && txtDrifterPathname.getText().trim().length() != 0) {
            ...
            /** output path */
            pathname = txtOutputpath.getText().trim().length() == 0
                    ? "null"
            ...
            /** output filename */
            pathname = txtOutputFilename.getText().trim().length() == 0
        ...
        private ArrayList<String> getInputList(String path, String fileMask) throws
            ...
            if (listFile.length == 0) {
                throw new IOException(path +
                        " contains no file matching mask " + fileMask);
            }
            ...
            if (location.startsWith("dods:") | location.startsWith("http:")) {
                try {
                    ...
                    throw new IOException(location +
                            " is not a valid OPeNDAP URL." + e.getMessage());
                }
            }
            return false;
        }
        ...
        public void createUI() {
            ...
            ckBoxGridfile = new JCheckBox(Resources.CK_BOX_GRIDFILE, false);
            txtGridfile = new JTextField();
            txtGridfile.setEditable(false);
            btnGridfile = new JButton("...");
            btnGridfile.setEnabled(false);
            ...
            pnlInput.add(txtFilenameFilter,
                    ...
                    GridBagConstraints.HORIZONTAL,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(ckBoxGridfile,
                    new GridBagConstraints(0, 2, 1, 1, 10, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.NONE,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(new JLabel(Resources.LBL_GRIDFILE),
                    new GridBagConstraints(0, 3, 1, 1, 10, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.BOTH,
                    new Insets(2, 25, 2, 5), 0, 0));
            pnlInput.add(txtGridfile,
                    new GridBagConstraints(1, 3, 1, 1, 80, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(btnGridfile,
                    new GridBagConstraints(2, 3, 1, 1, 10, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.NONE,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(new JLabel(Resources.LBL_DRIFTER_PATH),
                    new GridBagConstraints(0, 4, 1, 1, 10, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.BOTH,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(txtDrifterPathname,
                    new GridBagConstraints(1, 4, 1, 1, 80, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.HORIZONTAL,
                    new Insets(2, 5, 2, 5), 0, 0));
            pnlInput.add(btnDrifterPathname,
                    new GridBagConstraints(2, 4, 1, 1, 10, 10,
                    GridBagConstraints.WEST,
                    GridBagConstraints.NONE,
                    new Insets(2, 5, 2, 5), 0, 0));
            ...
            btnOutputpath.setEnabled(false);
        ...
        public void addListeners() {
            ...
            ckBoxGridfile.addActionListener(this);
            btnGridfile.addActionListener(this);
            ...
            ckBoxGridfile.addMouseListener(ConfigurationUI.this);
            btnGridfile.addMouseListener(ConfigurationUI.this);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            /** ckBoxGridfile */
            if (source == ckBoxGridfile) {
                hasChanged = true;
                boolean selected = ckBoxGridfile.isSelected();
                txtGridfile.setEnabled(selected);
                btnGridfile.setEnabled(selected);
                gridfile = selected
                        ? txtGridfile.getText()
                        : null;
            ...
            /** btnGridfile */
            if (source == btnGridfile) {
                String path = URI.create(txtGridfile.getText()).getPath();
                JFileChooser chooser = new JFileChooser(path);
                chooser.setDialogType(JFileChooser.OPEN_DIALOG);
                chooser.setFileFilter(new FileNameExtensionFilter(Resources.EXTENSION_NETCDF + " (*.nc; *.nc.1)", "nc", "1"));
                int returnPath = chooser.showOpenDialog(ConfigurationUI.this);
                if (returnPath == JFileChooser.APPROVE_OPTION) {
                    hasChanged = true;
                    gridfile = chooser.getSelectedFile().toString();
                    txtGridfile.setText(gridfile);
                    statusBar.setMessage(statusBarMsg = "Gridfile: " +
                            txtGridfile.getText());
                    tabTime.refresh();
                    tabModel.refresh();
                    tabVariable.refresh();
            ...
            if (source == btnOutputpath) {
                JFileChooser chooser = new JFileChooser(txtOutputpath.getText());
                chooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
                int returnPath = chooser.showOpenDialog(ConfigurationUI.this);
                if (returnPath == JFileChooser.APPROVE_OPTION) {
                    hasChanged = true;
                    txtOutputpath.setText(uriCurrent.relativize(chooser.getSelectedFile().toURI()).getPath());
            ...
            if (source == btnDrifterPathname) {
                ...
                chooser.setDialogType(JFileChooser.OPEN_DIALOG);
                chooser.setFileFilter(new FileNameExtensionFilter(Resources.EXTENSION_DRIFTER + " (*.drf; *.txt; *.nc)", "drf",
                        "txt", "nc"));
                int returnPath = chooser.showOpenDialog(ConfigurationUI.this);
                if (returnPath == JFileChooser.APPROVE_OPTION) {
                    hasChanged = true;
                    txtDrifterPathname.setText(uriCurrent.relativize(chooser.getSelectedFile().toURI()).getPath());
            ...
            if (hasChanged) {
                (ConfigurationUI.this).valueChanged(new ValueChangedEvent((Component) e.getSource()));
            }
        }
        ...
        public void setToolTips() {
            ...
            ckBoxGridfile.setToolTipText(Resources.TIP_CK_BOX_GRIDFILE);
            btnGridfile.setToolTipText(Resources.TIP_BTN_GRIDFILE);
            txtGridfile.setToolTipText(Resources.TIP_BTN_GRIDFILE);
...
////////////////////////////////////////////////////////////////////////////////
    private class TabModel extends JPanel implements ITab {
        ...
        public void read(INIFile file) {
            ...
            /** Euler vs Rk4 */
            int typeScheme = file.getIntegerProperty(Structure.SECTION_MODEL,
                    Structure.SCHEME);
        ...
        private void refresh() {
            ...
            if (tabIO.listInputFiles != null) {
                try {
                    getNcInfo(tabIO.listInputFiles.get(0), tabIO.gridfile);
                    statusBar.setMessage(statusBarMsg =
         ...
         * @throws IOException
         */
        private void getNcInfo(String path, String gridfile) throws IOException {

            NetcdfFile ncIn, ncGrid;
            Array arrLon, arrLat;
            float lonMin, lonMax, latMin, latMax;

            ncIn = NetcdfDataset.openFile(path, null);
            ncGrid = (gridfile != null)
                    ? NetcdfDataset.openFile(gridfile, null)
                    : ncIn;
            ...
            arrLon = ncGrid.findVariable(NCField.lon.getName(model)).read();
            arrLat = ncGrid.findVariable(NCField.lat.getName(model)).read();
        ...
        public void createUI() {
            ...
            pnlType.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
...
////////////////////////////////////////////////////////////////////////////////
    private class TabTime extends JPanel implements ITab,
        ...
        private JTextField txtDatasetDt,  txtDatasetRecordDt,  txtAcceptableDt;
        private JButton btnFillBeginingSimulation,  btnFillTransportDuration,  btnFillDt;
        ...
        public void read(INIFile file) {
            ...
            if (typeCalendar == Constant.GREGORIAN) {
                ...
                try {
                    calendarOrigin.setTime(dtFormat.parse(file.getStringProperty(
            ...
            prmBeginingSimulation.setDefaultValue(file.getLongProperty(
                    ...
                    1000L);
            prmBeginingSimulation.setValue(prmBeginingSimulation.getDefaultValue().longValue());
            prmTransportDuration.setDefaultValue(file.getLongProperty(
                    Structure.SECTION_TIME,
                    Structure.TRANSPORT_DURATION) * 1000L);
            prmTransportDuration.setValue(prmTransportDuration.getDefaultValue().longValue());
            if (typeCalendar == Constant.GREGORIAN) {
                rdBtnGregorian.doClick();
            } else {
                rdBtnClimato.doClick();
            }
            prmDt.setValue(file.getIntegerProperty(Structure.SECTION_TIME, Structure.DT));
        ...
        private void getNcInfo(String path, String gridfile) throws IOException,
            ...
            try {
                ...
                ncIn = NetcdfDataset.openFile(tabIO.listInputFiles.get(tabIO.listInputFiles.size() - 1), null);
                ...
                dgrid = 0.d;
                if (model == Constant.ROMS) {
                    nx = ncIn.findDimension(NCField.xiDim.getName(Constant.ROMS)).
                            getLength();
                    ny = ncIn.findDimension(NCField.etaDim.getName(Constant.ROMS)).
                            getLength();
                    arrPm = ncGrid.findVariable(NCField.pm.getName(Constant.ROMS)).
                            read();
                    arrPn = ncGrid.findVariable(NCField.pn.getName(Constant.ROMS)).
                            read();
                    for (int i = 0; i < nx; i++) {
                        for (int j = 0; j < ny; j++) {
                            dgrid = Math.max(dgrid,
                                    Math.max(arrPm.getDouble(arrPm.getIndex().set(j, i)),
                                    arrPn.getDouble(arrPn.getIndex().set(j, i))));
                        }
                    }
                    dgrid = 1 / dgrid;
                } else {
                    try {
                        arrLat = ncGrid.findVariable(NCField.lat.getName(
                                Constant.MARS)).read("0:1");
                        arrLon = ncGrid.findVariable(NCField.lon.getName(
                                Constant.MARS)).read("0:1");
                        ...
                        throw new IOException("Error reading fields " +
                                NCField.lat.getName(Constant.MARS) + " " +
                                NCField.lon.getName(Constant.MARS));
                    }
                }
            } catch (NullPointerException e) {
        ...
        private String humanReadable(double durationSecond) {
            ...
            int i = 0;
            NumberFormat nbFormat = NumberFormat.getIntegerInstance(Locale.US);
        ...
        double geodesicDistance(double lat1, double lon1, double lat2,
            ...
            double d = 6367000.0f * Math.sqrt(2.0f - 2.0f *
        ...
        public void createUI() {
            ...
            pnlArrow.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
            ...
            pnlTime.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
            ...
            pnlInfo.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        ...
        public void keyReleased(KeyEvent e) {
            ...
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                (ConfigurationUI.this).valueChanged(new ValueChangedEvent(e.getComponent()));
            }
        ...
        public void setToolTips() {
            ...
            rdBtnClimato.setToolTipText(Resources.TIP_RD_BTN_CLIMATO_CALENDAR);
            rdBtnGregorian.setToolTipText(Resources.TIP_BTN_GREGORIAN_CALENDAR);
            prmBeginingSimulation.setToolTipText(Resources.TIP_PRM_BEGIN_SIMU);
            prmDt.setToolTipText(Resources.TIP_PRM_DT);
            prmTransportDuration.setToolTipText(Resources.TIP_PRM_DURATION_TRANSPORT);
            txtOrigin.setToolTipText(Resources.TIP_TXT_ORIGIN);
            btnFillBeginingSimulation.setToolTipText(Resources.TIP_BTN_FILL_T0);
            btnFillTransportDuration.setToolTipText(Resources.TIP_BTN_FILL_DURATION);
...
////////////////////////////////////////////////////////////////////////////////
    private class TabTransport extends JPanel implements ITab {
        ...
        // Declaration of the variables
        ///////////////////////////////
        private JCheckBox ckBoxAdvectH,  ckBoxAdvectV,  ckBoxDisperseH,  ckBoxDisperseV,  ckBoxBuoyancy,  ckBoxMigration;
        ...
        public void read(INIFile file) {
            ...
            if (dimension == Constant.SIMU_2D) {
                ...
                /** buoyancy */
                boolean bln = file.getBooleanProperty(Structure.SECTION_TRANSPORT,
                        Structure.BUOYANCY);
                if (bln) {
                    ckBoxBuoyancy.setSelected(false);
                    ckBoxBuoyancy.doClick();
                    prmDensity.setValue(file.getDoubleProperty(Structure.SECTION_TRANSPORT,
                            Structure.EGG_DENSITY).floatValue());
                    prmAgeBuoyancy.setValue(file.getDoubleProperty(Structure.SECTION_TRANSPORT,
                            Structure.BUOYANCY_AGE_LIMIT).floatValue());
                }

                /** vertical migration */
                migration = file.getBooleanProperty(Structure.SECTION_TRANSPORT,
                        Structure.MIGRATION);
                if (migration) {
        ...
        public void write(INIFile file) throws IOException {
            ...
            if (ckBoxBuoyancy.isSelected() && ckBoxMigration.isSelected() && !tabBiology.ckBoxGrowth.isSelected()) {
                if (prmAgeBuoyancy.getValue().floatValue() >
                        prmAgeMigration.getValue().floatValue()) {
                    throw new IOException(Resources.PRM_AGE_LIMIT_BUOYANCY + " should be inferior to " + Resources.PRM_AGE_LIMIT_MIGRATION);
                }
            }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == rdBtn3D) {
                ...
                tabRelease.prmPatchThickness.setEnabled(tabRelease.ckBoxPatchiness.isSelected());
                tabVariable.refresh();
            }
            ...
            if (source == ckBoxBuoyancy) {
                ...
                prmAgeBuoyancy.setEnabled(selected && !tabBiology.ckBoxGrowth.isSelected());
            }
        ...
        public void setToolTips() {
            ...
            prmAgeMigration.setToolTipText(Resources.TIP_PRM_AGE_LIMIT_MIGRATION);
        }
    }
...
////////////////////////////////////////////////////////////////////////////////
    private class TabRelease extends JPanel implements ITab {
        ...
        public void read(INIFile file) {
            ...
            boolean bln = (file.getIntegerProperty(Structure.SECTION_RELEASE,
                    Structure.TYPE_RELEASE) == Constant.RELEASE_ZONE);
            if (bln) {
                rdBtnZone.doClick();
                prmNbReleased.setValue(file.getIntegerProperty(Structure.SECTION_RELEASE,
                        Structure.NB_PARTICLES));
                prmDepthMin.setValue(file.getIntegerProperty(Structure.SECTION_RELEASE,
                        Structure.DEPTH_MIN));
                prmDepthMax.setValue(file.getIntegerProperty(Structure.SECTION_RELEASE,
                        Structure.DEPTH_MAX));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == rdBtnZone) {
                ...
                prmPatchThickness.setEnabled(ckBoxPatchiness.isSelected() &&
                        !tabTransport.rdBtn2D.isSelected());
                if (file != null &&
...
////////////////////////////////////////////////////////////////////////////////
    private class TabRecruitment extends JPanel implements ITab {
        ...
        public void createUI() {
            ...
            rdBtnRecruitNone = new JRadioButton(Resources.RD_BTN_RECRUIT_NONE, true);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == tabBiology.ckBoxGrowth) {
                rdBtnRecruitLength.setEnabled(tabBiology.ckBoxGrowth.isSelected());
            ...
            if (source == rdBtnRecruitAge) {
                ...
                if (file != null && (recruitmentZoneEditor.length() == 0)) {
        ...
        public void setToolTips() {
            ...
            prmDurationRecruit.setToolTipText(Resources.TIP_RECRUIT_DURATION_MIN);
            ...
            rdBtnRecruitLength.setToolTipText(Resources.TIP_RD_BTN_RECRUIT_LENGTH);
            ckBoxDepthRecruit.setToolTipText(Resources.TIP_CK_BOX_RECRUIT_DEPTH);
            prmMinDepthRecruit.setToolTipText(Resources.TIP_PRM_RECRUIT_MIN_DEPTH);
            prmMaxDepthRecruit.setToolTipText(Resources.TIP_PRM_RECRUIT_MAX_DEPTH);
    ...
    private class TabBiology extends JPanel implements ITab {
        ...
        public void read(INIFile file) {
            ...
            if (bln) {
                ...
                prmLethalTpEgg.setValue(file.getDoubleProperty(Structure.SECTION_BIO, Structure.LETHAL_TP_EGG).
                        floatValue());
                if (ckBoxGrowth.isSelected()) {
                    prmLethalTpLarva.setValue(file.getDoubleProperty(Structure.SECTION_BIO, Structure.LETHAL_TP_LARVA).
                            floatValue());
                }
            }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == ckBoxGrowth) {
                ...
                ckBoxPlankton.setSelected(false);
                tabTransport.prmAgeBuoyancy.setEnabled(tabTransport.ckBoxBuoyancy.isSelected() && !ckBoxGrowth.isSelected());
                tabTransport.prmAgeMigration.setEnabled(tabTransport.ckBoxMigration.isSelected() && !ckBoxGrowth.isSelected());
                prmLethalTpLarva.setEnabled(ckBoxLethalTp.isSelected() && ckBoxGrowth.isSelected());
    ...
    private class TabVariable extends JPanel implements ITab {
        ...
        private boolean apply() {
            ...
            for (int i = 0; i < nRow; i++) {
                if (variables[i].isRequired(model + dimension)) {
                    if (((String) table.getModel().getValueAt(i, 1)).trim().length() == 0) {
            ...
            for (int i = 0; i < variables.length; i++) {
                if (variables[i].isRequired(model + dimension)) {
                    name = ((String) table.getModel().getValueAt(i, 1)).trim();
        ...
        private void refresh() {
            ...
            setUpNameColumn(path, tabIO.gridfile);
            findUndefined();
        }
        ...
        private boolean isRutgers(String path) {
            ...
            if (model == Constant.ROMS && path != null) {
                try {
                    ...
                    if (ncIn.findVariable(NCField.thetaS.getName(Constant.ROMS)) != null) {
                        return true;
                    }
                } catch (IOException e) {
                    printErr(new IOException(
         ...
         * @param path String
         */
        public void setUpNameColumn(String path, String gridpath) {

            try {
                fillComboBox(path, gridpath);
            } catch (IOException e) {
                printErr(e,
         ...
         *
         */
        private void fillComboBox(String path, String gridpath) throws IOException {

            String[] listDim = new String[]{"[undef]"},
            ...
            try {
                if (path != null) {
                    ...
                    i = 0;
                    listAttrib = new String[ncIn.getGlobalAttributes().size() + 1];
                    ...
                    i = 0;
                    if (gridpath != null) {
                        NetcdfFile ncGrid = NetcdfDataset.openFile(gridpath, null);
                        listVar = new String[ncIn.getVariables().size() + ncGrid.getVariables().size() + 2];
                        ncGrid.close();
                    ...
                    if (gridpath != null) {
                        NetcdfFile ncGrid = NetcdfDataset.openFile(gridpath, null);
                        iterVar = ncGrid.getVariables().iterator();
                        while (iterVar.hasNext()) {
                            var = (Variable) iterVar.next();
                            listVar[i++] = var.getName();
                        }
                ...
                throw new IOException("Error listing the variables of dataset " + path);
            } finally {
            ...
            private Object[] getLongValues(Object[][] data) {
                ...
                for (int i = 0; i < data.length; i++) {
                    ...
                    for (int j = 0; j < data[i].length; j++) {
                        ...
                        if (value != null && (value.length() > longuest[i].length())) {
                            longuest[i] = value;
                        }
                    }
                }
