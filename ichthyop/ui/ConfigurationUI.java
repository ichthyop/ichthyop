    ...
    private class TabIO extends JPanel implements ITab,
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == ckBoxOutput) {
                hasChanged = true;
                prmRecordDt.setEnabled(ckBoxOutput.isSelected());
            }
...
////////////////////////////////////////////////////////////////////////////////
    private class TabTime extends JPanel implements ITab,
        ...
        private JPanel pnlInfo, pnlTime;
        ...
        private void getNcInfo(String path) throws IOException,
            ...
            int length, nx, ny;
            double t0, maxDuration, dgrid, datasetDtR, datasetDt;
            ...
            try {
                ...
                maxDuration = arrTime.getDouble(indexN);
                ncIn = NetcdfDataset.openFile(tabIO.listInputFiles.get(0), null);
                arrTime = ncIn.findVariable(NCField.time.getName(model)).read();
                index0 = arrTime.getIndex().set(0);
                maxDuration -= arrTime.getDouble(index0);
        ...
        public void createUI() {
            ...
            this.add(pnlInfo, new GridBagConstraints(0, 0, 1, 1, 100, 50,
                    GridBagConstraints.WEST,
                    GridBagConstraints.BOTH,
                    new Insets(5, 5, 5, 5), 0, 0));

            this.add(pnlTime, new GridBagConstraints(0, 1, 1, 1, 100, 50,
                    GridBagConstraints.WEST,
                    GridBagConstraints.BOTH,
                    new Insets(5, 5, 5, 5), 0, 0));
    ...
    private class TabRecruitment extends JPanel implements ITab {
        ...
        public void createUI() {
            ...
            this.add(recruitmentZoneEditor,
                     new GridBagConstraints(0, 4, 3, 1, 90,
                                            40,
                                            GridBagConstraints.WEST,
                                            GridBagConstraints.NONE,
                                            new Insets(2, 5, 2, 5), 0, 0));
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                File file = new File(
                        "/home/pverley/previmer/program/cfg/single_safe_wc_1.cfg");
