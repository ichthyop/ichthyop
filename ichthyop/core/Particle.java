...
///////////////////////////////
    ...
    private double hatching_density;
...
////////////////////////////
    ...
    void init() {
        ...
        if (FLAG_BUOYANCY) {
            ...
            double sal_hatching_depth = data.getSalinity(hatching_position, Simulation.get_t0());
            hatching_density = BuoyancyScheme.waterDensity(sal_hatching_depth, tp_hatching_depth);
        }
    }
