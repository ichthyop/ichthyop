...
public class RunBatch {
     ...
     */
    public class SerialSwingWorker extends SafeSwingWorker<Object, StepSerial> {

        /**
         * The {@code Step} object holding information about the current
         * step of the run.
         */
        private StepSerial step;
         ...
         */
        @Override
        protected void process(java.util.List<StepSerial> steps) {

            int lengthStr = 0;
            for (StepSerial lstep : steps) {
