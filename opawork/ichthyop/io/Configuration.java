...
///////////////////////////////
    ...
    private static String PATTERN_GRID_U;
    private static String PATTERN_GRID_V;
    private static String PATTERN_GRID_W;
    // modif sp : lecture du kv
    private static String PATTERN_GRID_T;
    private static String PATTERN_HGR;
    private static String PATTERN_ZGR;
    private static String PATTERN_BYTE_MASK;
...
//////////////
    ...
    public Configuration(File file) throws IOException {
        ...
        try {
        read(new INIFile(file.toString()));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
////////////////////////////
    ...
    private void readIO(INIFile file, String section) {
        ...
        PATTERN_GRID_U = readString(file, section, Structure.PATTERN_GRID_U);
        PATTERN_GRID_V = readString(file, section, Structure.PATTERN_GRID_V);
	PATTERN_GRID_W = readString(file, section, Structure.PATTERN_GRID_W);
	// modif sp : lecture du kv
        PATTERN_GRID_T = readString(file, section, Structure.PATTERN_GRID_T);
        PATTERN_HGR = readString(file, section, Structure.PATTERN_HGR);
        PATTERN_ZGR = readString(file, section, Structure.PATTERN_ZGR);
        PATTERN_BYTE_MASK = readString(file, section, Structure.PATTERN_MASK);
    }
    ...
    private void readReleaseTxt(INIFile file, String section) throws
        ...
        if (!fDrifter.exists() || !fDrifter.canRead()) {
            throw new IOException("Drifter file " + PATH_FILE_DRIFTERS
                                  + " cannot be read");
        }
        NB_PARTICLES = 0;
        RELEASE_DT = new int[] {0};
    ...
    private void readReleaseNc(INIFile file, String section) throws IOException {
        ...
        try {
            ...
            throw new IOException("Problem reading Ichthyop output file "
                                  + PATH_FILE_DRIFTERS);
        }
...
//////////
    ...
    public static String getPatternGridU() {
        return PATTERN_GRID_U;
    }
    
    public static String getPatternGridV() {
        return PATTERN_GRID_V;
    }
 
    public static String getPatternGridW() {
        return PATTERN_GRID_W;
    }
    //modif sp : lecture du kv
    
    public static String getPatternGridT() {
        return PATTERN_GRID_T;
    }
    
    public static String getPatternHGR() {
        return PATTERN_HGR;
    }
    
    public static String getPatternZGR() {
        return PATTERN_ZGR;
    }
    
    public static String getPatternByteMask() {
        return PATTERN_BYTE_MASK;
    }
    ...
    public static String getStrXiDim() {
        return NCField.xiDim.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrEtaDim() {
        return NCField.etaDim.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrZDim() {
        return NCField.zDim.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrTimeDim() {
        return NCField.timeDim.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrLon() {
        return NCField.lon.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrLat() {
        return NCField.lat.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrBathy() {
        return NCField.bathy.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrMask() {
        return NCField.mask.getName();
    }
    ...
    public static String getStrTp() {
        return NCField.temp.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrSal() {
        return NCField.sal.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrZeta() {
        return NCField.zeta.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrE2t() {
        return NCField.e2t.getName();
    }

    //--------------------------------------------------------------------------
    public static String getStrE1t() {
        return NCField.e1t.getName();
    }
    
    //--------------------------------------------------------------------------
    public static String getStrE1v() {
        return NCField.e1v.getName();
    }
    
    //--------------------------------------------------------------------------
    public static String getStrE2u() {
        return NCField.e2u.getName();
    }
    
    //--------------------------------------------------------------------------
    public static String getStrE3t() {
        return NCField.e3t.getName();
    }
    
    //--------------------------------------------------------------------------
    public static String getStrGdepw() {
        return NCField.gdepw.getName();
    }
    
    //--------------------------------------------------------------------------
    public static String getStrGdept() {
        return NCField.gdept.getName();
    }
    //--------------------------------------------------------------------------
    public static String getStrTime() {
        return NCField.time.getName();
    }

    public static String getStrKv() {
        return NCField.kv.getName();
    }
