...
///////////////////////////////
     ...
     * 
     */
    private static ArrayFloat.D2 arrKz;
    /**
...
////////////////////////////
    ...
    public static void init(Population pop) {
        ...
        if (FLAG_VDISP) {
            arrKz = new ArrayFloat.D2(1, Configuration.getNbParticles());
        }
        population = pop;
    ...
    public static void write(double time) {
        ...
        while (iter.hasNext()) {
            ...
            if (FLAG_VDISP) {
                arrKz.set(0, i, (float) particle.getKz(time));
            }
        }
        arrTime.set(0, time);
        ...
        if (FLAG_VDISP) {
            write2NcOut(Field.KZ, origin, arrKz);
        }
    ...
    public enum Field {
        LONGITUDE("lon", "particle longitude", "degree east", DataType.FLOAT),
                ...
                SMALL_ZOO("smallZoo",
                          ...
                          "mMol N m-3",
                          DataType.FLOAT),
                KZ("kz", "vertical diffusion coefficient", "m2.s-1", DataType.FLOAT);
