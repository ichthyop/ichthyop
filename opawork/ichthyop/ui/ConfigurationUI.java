...
////////////////////////////////////////////////////////////////////////////////
    private class TabModel extends JPanel implements ITab {
        ...
        private void getNcInfo(String path) throws IOException {
            ...
            arrLon = ncIn.findVariable(NCField.lon.getName()).read();
            arrLat = ncIn.findVariable(NCField.lat.getName()).read();
    ...
    private class TabTime extends JPanel implements ITab,
        ...
        private void getNcInfo(String path) throws IOException,
            ...
            try {
                ...
                arrTime = ncIn.findVariable(NCField.time.getName()).
                          read();
                ...
                arrTime = ncIn.findVariable(NCField.time.getName()).read();
                ...
                dgrid = 0.d;
                if (model == Constant.ROMS) {
                    nx = ncIn.findDimension(NCField.xiDim.getName()).
                         getLength();
                    ny = ncIn.findDimension(NCField.etaDim.getName()).
                         getLength();
                    arrPm = ncIn.findVariable(NCField.e1t.getName()).
                            read();
                    arrPn = ncIn.findVariable(NCField.e2t.getName()).
                            read();
                    for (int i = 0; i < nx; i++) {
                        for (int j = 0; j < ny; j++) {
    ...
    private class TabRecruitment extends JPanel implements ITab {
        ...
        public void createUI() {
            ...
            this.add(recruitmentZoneEditor,
                     new GridBagConstraints(0, 7, 3, 1, 90,
                                            40,
                                            GridBagConstraints.WEST,
                                            GridBagConstraints.NONE,
                                            new Insets(2, 5, 2, 5), 0, 0));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == tabBiology.ckBoxGrowth) {
                ...
                if (rdBtnRecruitLength.isSelected()) {
                    rdBtnRecruitNone.setSelected(true);
    ...
    private class TabVariable extends JPanel implements ITab {
        ...
        public void write(INIFile file) {
            ...
            for (int i = 0; i < variable.length; i++) {
                String name = variable[i].isRequired()
                              ? variable[i].getName()
                              : "null";
        ...
        private void findUndefined() {
            ...
            for (int i = 0; i < variable.length; i++) {
                if (variable[i].isRequired()) {
                    ...
                    table.getModel().setValueAt(variable[i].getName(), i,
                                                1);
                }
            }
            if (foundAll) {
        ...
        class MyTableModel extends AbstractTableModel {
            ...
            public boolean isCellEditable(int row, int col) {
                ...
                if (col < 1) {
                    ...
                    return NCField.values()[row].isRequired();
                }
            }
        ...
        class MyCellRenderer extends DefaultTableCellRenderer {
            ...
            public Component getTableCellRendererComponent(JTable table,
                ...
                if (!NCField.values()[row].isRequired()) {
