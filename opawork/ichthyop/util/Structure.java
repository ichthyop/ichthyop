...
public interface Structure {
    ...
    final public static String PATTERN_GRID_U = "pattern gridu";
    
    final public static String PATTERN_GRID_V = "pattern gridv";

    final public static String PATTERN_GRID_W = "pattern gridw";
    // modif sp : lecture du kv
    
    final public static String PATTERN_GRID_T = "pattern gridt";
    
    final public static String PATTERN_HGR = "pattern hgr";
    
    final public static String PATTERN_ZGR = "pattern zgr";
    
    final public static String PATTERN_MASK = "pattern mask";
