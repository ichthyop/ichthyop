...
//////////////////////////////
    ...
    private ArrayList<String> listUFiles, listVFiles, listTFiles;
    
    private static NetcdfFile ncU, ncV, ncT;
...
////////////////////////////
    ...
    public void init() throws IOException {
        ...
        if (Configuration.isVDisp()) {
            if (ncU.findVariable(strKv) == null) {
                throw new IOException(
                        "Cannot simulate vertical dispersion. Diffusion field " + strKv + " not found in file " + ncU.getLocation());
            } else {
                FLAG_VDISP = true;
                random = new MTRandom();
            }
