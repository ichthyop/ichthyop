...
public class TestGetParameter {
    ...
    @Test
    public void checkConfigurationFile() throws Exception {
    ...
    public void checkParameter() {
        ...
        expected = "year 2010 month 05 day 13 at 10:00";
        actual = cfgFile.getXParameter("initial_time").getValues();
        assertEquals(expected, actual);


        expected = "false";
        actual = cfgFile.getXParameter("skip_sorting").getValues();
        assertEquals(expected, actual);
