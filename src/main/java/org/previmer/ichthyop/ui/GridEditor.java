 ...
 */
public class GridEditor extends AbstractCellEditor implements ActionListener, TableCellEditor {
    ...
    public GridEditor(String template) {
        ...
        gridEditorPanel = new GridEditorPanel();
        optionPane = new JOptionPane(gridEditorPanel,
                JOptionPane.PLAIN_MESSAGE,
                JOptionPane.OK_CANCEL_OPTION);
        dialog = new JDialog(new JFrame(), false);
        dialog.setTitle(getResource().getString("GridEditor.title"));
    ...
    private void saveAndEditNewFile(File file) throws IOException {
        ...
        try {
            //gridEditor.loadZonesFromFile(file);
        } catch (Exception ex) {
            Logger.getLogger(GridEditor.class.getName()).log(Level.SEVERE, null, ex);
        }
        dialog.setVisible(true);
