...
public class JConfigurationPanel extends javax.swing.JPanel implements TreeSelectionListener, TableModelListener, ListSelectionListener, ActionListener {
     ...
     *
     */
    private static final long serialVersionUID = 7577771253338900323L;
    ...
    private class ShowConfigEditorsTask extends Task<Object, Object> {
    ...
    @Action
    public Task<Object, Object> addSerialValue() {
        return new SerialValueTask(SerialValueTask.ADD);
    }

    @Action
    public Task<Object, Object> removeSerialValue() {
        return new SerialValueTask(SerialValueTask.REMOVE);
    }

    private class SerialValueTask extends Task<Object, Object> {
    ...
    public Task<Object, Object> loadBlockTree() {
        return new CreateBlockTreeTask(IchthyopApp.getApplication());
    }

    private class CreateBlockTreeTask extends SFTask<Object, Object> {
