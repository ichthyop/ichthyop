...
import org.previmer.ichthyop.manager.AbstractManager;

/**
 *
 * @author pverley
 */
public class GridManager extends AbstractManager {

    final private static GridManager gridManager = new GridManager();
