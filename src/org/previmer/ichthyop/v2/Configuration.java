...
///////////////////////////////
    ...
    private static ArrayList<ZoneV2> listReleaseZone;
    ...
    private static ArrayList<ZoneV2> listRecruitmentZone;
...
////////////////////////////
     ...
     * file.
     */
    private ArrayList<ZoneV2> readZone(INIFile file, int type) {

        ArrayList<ZoneV2> list;
...
//////////
    ...
    public static int getTimeOrigin(int field) {
        ...
        InterannualCalendar cld = new InterannualCalendar();
    ...
    //---------------------------------------------------------
    public static ArrayList<ZoneV2> getRecruitmentZones() {
        return listRecruitmentZone;
    }

    //---------------------------------------------------------
    public static ArrayList<ZoneV2> getReleaseZones() {
