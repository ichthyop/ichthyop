 ...
 * @author mariem
 */
public class TemperatureTracker extends AbstractTracker {
    ...
    @Override
    void setDimensions() {
        addTimeDimension(); // A redéfinir selon le temps qu'on va utiliser
        addAliveDimension(); 
    }
    ...
    public void track() {
        ...
        while (iter.hasNext()) {
            particle = iter.next();
            getArray().set(0, particle.getIndex(), particle.getTemperature());
        }
    }
