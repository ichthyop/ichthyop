 ...
 */
public class FlawedCalendar extends Calendar {
...
///////////////
     ...
     */
    public FlawedCalendar(int year, int month, int day, int hour, int minute) {
    ...
    public FlawedCalendar(String origin, SimpleDateFormat dateFormat) throws ParseException {
