...
////////////////////////////
    ...
    private static long millisToDay(long millis) {
        return (millis / CalendarConstants.ONE_DAY);
    }
    ...
    private static long dayToMillis(long day) {
        return day * CalendarConstants.ONE_DAY;
    }
    ...
    protected void computeFields() {
        ...
        boolean isLeap;
        long epoch_hour = epoch_fields[HOUR_OF_DAY] * CalendarConstants.ONE_HOUR + epoch_fields[MINUTE] * CalendarConstants.ONE_MINUTE;
        ...
        int millisInDay = (int) (time + epoch_hour - timeInDay * CalendarConstants.ONE_DAY);
        if (millisInDay < 0) {
            millisInDay += CalendarConstants.ONE_DAY;
        }
    ...
    protected void computeTime() {
        ...
        long millisInDay = fields[MILLISECOND]
                + fields[SECOND] * CalendarConstants.ONE_SECOND
                + fields[MINUTE] * CalendarConstants.ONE_MINUTE
                + fields[HOUR_OF_DAY] * CalendarConstants.ONE_HOUR;
        long epoch_hour = epoch_fields[HOUR_OF_DAY] * CalendarConstants.ONE_HOUR + epoch_fields[MINUTE] * CalendarConstants.ONE_MINUTE;
