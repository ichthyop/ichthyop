 ...
 */
public class TimeConverterDialog extends JDialog {
    ...
    public TimeConverterDialog(java.awt.Frame parent) {
        super(parent);
        initComponents();
    }
    ...
    public void convert() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(TimeConverterDialog.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        JScrollPane scrollPaneConversion = new JScrollPane();
        tableConversion = new JTable();
        JLabel lblHelp = new JLabel();

        ResourceMap resourceMap = Application.getInstance().getContext().getResourceMap(TimeConverterDialog.class);
        ActionMap actionMap = Application.getInstance().getContext().getActionMap(TimeConverterDialog.class, this);

        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        setTitle(resourceMap.getString("title"));

        closeButton.setName("closeButton");
        closeButton.setAction(actionMap.get("closeDialog"));
